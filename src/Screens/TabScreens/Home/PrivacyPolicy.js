...
const data = [
  {
    title: 'Who we are',
    description: 'Our website address is: https://www.fiberlaserspares.com.',
  },
  {
    title: 'Comments',
    description:
...
const PrivacyPolicy = () => {
  return (
    <ScrollView style={styles.container} contentContainerStyle={{alignItems:'center',paddingVertical:10}}>
      {data?.map((item, index) => (
