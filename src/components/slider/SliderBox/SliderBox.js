...
import Carousel, { Pagination } from "../react-native-snap-carousel/src/index"; //Thank From distributer(s) of this lib
    ...
    return (
      <Pagination
        ...
        containerStyle={[
          ...
          paginationBoxVerticalPadding ? { paddingVertical: 10 } : {},
